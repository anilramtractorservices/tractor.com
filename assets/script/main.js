...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Fix header/banner image load
  const headerImg = document.querySelector('header img');
  if (headerImg) {
    headerImg.onload = () => console.log("Header image loaded");
    headerImg.src = headerImg.src; // force load
  }
});